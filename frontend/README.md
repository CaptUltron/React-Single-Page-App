topics covered
----------------------------
-> Routing : use of createBrowserRouter and RouterProvider from react-router-dom
-> use of Outlet component from react-router-dom
-> use of useParams hook from react-router-dom
